...
function DefaultNavbar({ brand, transparent, light, action, sticky, relative, connect }) {
  ...
  const MKmy = (() => {
    if (brand === "Squad Profile") return 0;
    if (brand === "Forum") return 0;
    if (brand === "Leagues") return 0;
    return 3;
  })();
  ...
  return (
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      <MKBox
        ...
        my={MKmy}
        mx={{ xs: relative ? 0 : 0, lg: 3 }}
        width={{ xs: relative ? "100%" : "calc(100% - 0px)", xl: "calc(100% - 48px)" }}
